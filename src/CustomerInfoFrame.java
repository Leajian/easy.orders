...
public class CustomerInfoFrame extends JFrame
{
	...
	public CustomerInfoFrame(String id)
	{
		db.connect();
		...
		try
		{
			...
			phone_numberField.setText(rs.getString("phone_number"));
			emailField.setText(rs.getString("email"));
			addressField.setText(rs.getString("address"));
			faxField.setText(rs.getString("fax"));
			zip_codeField.setText(rs.getString("zip_code"));
		...
		zip_codeField.setEditable(false);
		...
		saveButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				if(!(name.trim().equals("")))
				{
					try
					{
						String query = "UPDATE customer SET name = " + "'" + name + "', " + "city = " + "'" + city + "', " + "phone_number = " + "'" + phone_number + "', " + "email = " + "'" + email + "', " +  "address = " + "'" + address + "', " + "fax = " + "'" + fax + "', " + "zip_code = " + "'" + zip_code + "', " + "notes = " + "'" + notes + "' WHERE customer.id = " + "'" + id + "'";
		...
		editCheckBox.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				if(editCheckBox.isSelected())
				{
					...
					zip_codeField.setEditable(true);
